...
/opt/homebrew/opt/python@3.11/bin/python3 -c "print('Python installation successful!')" || handle_error "Failed to test Python installation."
...
tell application "Terminal"
    do script "cd $TARGET_DIR/folders/gpt-cli && source ~/.zshrc && /opt/homebrew/opt/python@3.11/bin/python3 gpt.py"
end tell
EOD
