...
def run_praat_file(m, p):
    ...
    """
    sound = os.path.join(p, "dataset", "audioFiles", m + ".wav")
    ...
    print("Checking audio file:", sound)
    print("Full path to audio file:", os.path.abspath(sound))
    print("Audio file exists:", os.path.isfile(sound))
    
    print("Checking Praat script:", sourcerun)
    print("Full path to Praat script:", os.path.abspath(sourcerun))
    print("Praat script exists:", os.path.isfile(sourcerun))
    
    print("Checking audio files directory:", path)
    print("Full path to audio files directory:", os.path.abspath(path))
    print("Audio files directory exists:", os.path.isdir(path))
    ...
    try:
        ...
        # This will print the info from the sound object, and objects[0] is a
        # parselmouth.Sound object
        print(objects[0])
        # This will print the info from the textgrid object, and objects[1] is
        # a parselmouth.Data object with a TextGrid inside
        z1 = str(objects[1])
        z2 = z1.strip().split()
        return z2
...
def myspgend(m, p):
    ...
    try:
        ...
        if z4 > 97 and z4 <= 114:
            ...
            print(
                "a Male, mood of speech: Reading, p-value/sample size= :%.2f" % (mmm),
                (nnn),
            )
        elif z4 > 135 and z4 <= 163:
            print(
            ...
            print(
                "a female, mood of speech: Reading, p-value/sample size= :%.2f" % (mmm),
                (nnn),
            )
...
def mysplev(m, p):
    ...
    try:
        for soundi in files:
            ...
            # print (objects[0]) # This will print the info from the sound
            # object, and objects[0] is a parselmouth.Sound object
            z1 = objects[
                1
