...
def main():
    ...
    dest_tsv = os.path.join("folders", "gpt-langtrans", f"{dirname}raw.tsv")
    ...
    os.chdir(os.path.join("folders", "gpt-langtrans"))
    ...
    source_csv = os.path.join("folders", "gpt-langtrans", f"{dirname}.csv")
