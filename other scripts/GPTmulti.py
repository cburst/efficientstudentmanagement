...
def main():
    ...
    dest_tsv = os.path.join("folders", "gpt-multi", f"{dirname}raw.tsv")
    ...
    os.chdir(os.path.join("folders", "gpt-multi"))
    ...
    source_csv = os.path.join("folders", "gpt-multi", f"{dirname}.csv")
